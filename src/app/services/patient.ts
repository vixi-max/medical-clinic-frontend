...
export class PatientService {
  ...
  private mapToPatient(response: PatientResponse): Patient {
    return {
      ...
      lastVisit: this.getLastVisitDate(response.dossierMedical),
      nextAppointment: this.getNextAppointmentDate(),
      status: this.determineStatus(response.dossierMedical?.dateCreation),
      ...
      allergies: this.extractAllergies(response.dossierMedical),
      chronicDiseases: this.extractChronicDiseases(response.dossierMedical),
      notes: '',
      dossierMedical: response.dossierMedical || undefined
    };
  }
